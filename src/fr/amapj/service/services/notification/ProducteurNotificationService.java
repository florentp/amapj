...
public class ProducteurNotificationService 
{
	...
	private void sendNotificationProducteur(Producteur producteur, RdbLink em, DeamonsContext deamonsContext)
	{
	...
	{
		NewTransaction.write(em->sendMessageAndMemorize(em,message,modeleContratDateId,utilisateurId));
	}
